...
public class CountView extends View {
    ...
    /**
     * 属性动画 自定义属性 get/set方法
     * @param offsetY 改变的属性: 偏移量
     * 注意字体绘制的坐标系的特殊性 可以画图帮助理解此方法
     */
    public void setTextOffsetY(float offsetY) {
        // 原来部分 的 y轴偏移量
        this.mOldOffsetY = offsetY;//变大是从[0,mTextSize]，变小是[0,-mTextSize]
        // 改变部分 的 y轴偏移量
        if (mCountToBigger) {//从下到上[-mTextSize,0] 数字变大
            this.mNewOffsetY = offsetY - mMaxOffsetY;
        } else {//从上到下[mTextSize,0]  数字变小
