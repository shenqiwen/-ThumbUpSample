...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        oldThumbUpView = (OldThumbUpView) findViewById(R.id.oldThumbUpView);
        newThumbUpView = (ThumbUpView) findViewById(R.id.newThumbUpView);
    ...
    public void setNum(View v) {
        try {
            ...
            newThumbUpView.setCount(num);
            newThumbUpView.setThumbUp(false);
        } catch (Exception e) {
            e.printStackTrace();
